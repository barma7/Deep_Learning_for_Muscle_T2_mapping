...
home_path = "C:\Users\mb7\OneDrive_Stanford\Research\WorkHome\Projects\Muscle-T2-Mapping\PHILIPS\DATA";
...
b1map_names = ["b1_s1.nii", "b1_s2.nii", "b1_s3.nii"];
...
for k = 1:length(subjects)
    ...
    sub = subjects(k);
    SvFldr = fullfile(home_path, sub, "nifti", sv_name);

    if ~exist(SvFldr, 'dir')
        mkdir(SvFldr);
    end
    
    data_fldr = fullfile(home_path, sub, "nifti");
